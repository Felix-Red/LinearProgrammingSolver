...
namespace LPR381_CPLEX.BusinessLogic
{
    class CuttingPlane
    {
        public void SolveIntegerProblem(string[] lines, string outputFilePath)
        {
            ...
            try
            {
                ...
                for (int i = 1; i < objectiveCoefficients.Length; i++)
                {
                    ...
                    INumVar var = cplex.IntVar(0, Int32.MaxValue);  // Initialize as integer variable
                ...
                // Solve the problem using cutting plane method
                if (cplex.Solve())
                {
